...
SHELL := /bin/bash
NAME := jx-project
BINARY_NAME := cd-indicators
BUILD_TARGET = build
MAIN_SRC_FILE=cmd/collector/main.go
...
BUILDFLAGS :=  -ldflags \
  " -X $(ROOT_PACKAGE)/pkg/version.Version=$(VERSION)\
		...
		-X github.com/jenkins-x/cd-indicators/internal/version.Version=$(VERSION)\
		-X github.com/jenkins-x/cd-indicators/internal/version.Revision='$(REV)'\
		-X github.com/jenkins-x/cd-indicators/internal/version.Date='$(BUILD_DATE)'\
		$(BUILD_TIME_CONFIG_FLAGS)"
